...
for i in range(0, 11):
    ...
    res = requests.get('https://movie.douban.com/subject/2133323/comments?start=' + str(
        20 * i) + '&limit=20&sort=new_score&status=P&percent_type=', timeout=30, headers=get_agent())
